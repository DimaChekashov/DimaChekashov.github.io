    ...
    <>
      ...
      >
        ...
        <div className={styles.contactLinks}>
          <Tilt>
            <a href="https://t.me/FoxSayJS" target="_blank" className={styles.contactLink} rel="noreferrer">
              <div className={styles.contactLinkIcon}>
                <svg width="82" height="82" viewBox="0 0 32 32" fill="black" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className={styles.contactLinkTitle}>
                Telegram
              </div>
            </a>
          </Tilt>
          <Tilt>
            <a href="https://career.habr.com/foxsayjs" target="_blank" className={styles.contactLink} rel="noreferrer">
              <div className={styles.contactLinkIcon}>
                <svg width="82" height="82" viewBox="0 0 32 32" fill="black" xmlns="http://www.w3.org/2000/svg">
          ...
          <Tilt>
            <a href="https://www.linkedin.com/in/foxsayjs" target="_blank" className={styles.contactLink} rel="noreferrer">
              <div className={styles.contactLinkIcon}>
                <svg width="82" height="82" viewBox="0 0 32 32" fill="black" xmlns="http://www.w3.org/2000/svg">
